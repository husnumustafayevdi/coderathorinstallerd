...
def logo (dil = "None"):
   ...
   console.print(Panel(f"[bold blue]@Coderator Installer :wolf:[/]\n\n[bold cyan]Version: [/][i]2.1[/]\n[bold cyan]Python: [/][i]{surum}[/]\n[bold cyan]Dil: [/][i]{dil}[/]"), justify="center")                         
def tamamlandi (saniye):
   console.print(Panel(f"[bold green]Qurulum Tamamlandı!\n[i]Botu {round(saniye)} saniyə içinde kurdunuz.[/]\n\n[bold green]2-3 dəqiqə sonra hər hansı bir sohbətə .alive yazaraq test edəbilərsiniz. Botunuz xeyirli olsun:)[/]"), justify="center")                         
